...
```bash
sudo bash -c "$(curl -fsSL https://raw.githubusercontent.com/biglittlefatskinny/AutoPaqet/main/AutoPaqet/Server/server_setup.sh)"
```
...
2. **PowerShell** running as **Administrator**
   - Windows blocks scripts by default. Run this once, then re-open PowerShell as Admin:
